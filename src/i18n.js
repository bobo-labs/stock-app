...
const dictionaries = {
  ...
  en: {
    brandSubtitle: 'Counter dashboard', language: 'Language', openMenu: 'Open menu', preparing: 'Preparing your dashboard…', overview: 'Overview', sales: 'Sales', inventory: 'Inventory', metricsNav: 'Metrics', activity: 'Activity',
