...
const dictionaries = {
  es: {
    ...
    paymentApproved: 'Pago aprobado', cardSaleCompleted: 'La venta con tarjeta quedó registrada y conciliada.', cashSaleCompleted: 'La venta en efectivo quedó registrada.', deliverPointReceipt: 'Entrega el comprobante desde el Point antes de iniciar otra venta.', pilotReceiptAutomatic: 'El comprobante piloto se imprimirá cuando el Point vuelva a la pantalla de inicio.', pilotReceiptSent: 'Comprobante piloto enviado al Point', pilotReceiptPrinted: 'Comprobante piloto impreso automáticamente', pilotReceiptFailed: 'No se pudo imprimir el comprobante piloto', retryPilotReceipt: 'Reintentar impresión piloto',
